<template>
                      ...
                      <li class="menu-item-has-children current-menu-item">
                        ...
                        <ul class="sub-menu">
                          ...
                          <li class="current-menu-item">
                            ...
                            <ul class="sub-menu">
                              <li class="current-menu-item">
                                <a href="gallery1.html">Gallery Grid</a>
                              </li>
  ...
  <div class="main-content">
    ...
    <div class="sc-gallery-section pt-120 pb-120 md-pt-80 md-pb-80">
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 loadcourse addcourse mb-30">
          ...
          <div class="col-lg-4 col-md-6 loadcourse addcourse hidecourse mb-30">
            <div class="gallery-item">
