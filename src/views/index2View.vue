<template>
  ...
  <div class="main-content">
    ...
    <div id="sc-banner" class="sc-banner banner-bg2 banner-style2 position-relative">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="banner-content">
              ...
              <h5
                class="banner-des white-color mb-35 wow fadeInUp"
                data-wow-delay="300ms"
          ...
          <div class="col-lg-6 hidden-md">
            <div
              class="banner-img hidden-sm wow fadeInRight"
              data-wow-delay="300ms"
              data-wow-duration="2000ms"
            >
        ...
        <div class="row grid">
          ...
          <div class="col-md-6 grid-item filter1 filter3">
            <div class="courses-grid mb-30 d-flex align-items-center">
              ...
              <div class="content-part">
                <h3 class="title"><a href="course-single.html#">Javascript learn Course...</a></h3>
                <div class="des">Excepteur sint occaecat cupidatat non proident, sunt in culpa</div>
                <ul class="meta-part">
                  <li class="user">
    ...
    <div
      class="sc-counter counter-bg2 pt-120 pb-90 md-pt-80 md-pb-50 position-relative arrow-animation-1"
    >
      <div class="container">
        <div class="row">
          <div class="col-lg-5">
            <div class="sec-title">
              <h2 class="title mb-10 white-color">
                Why we learn with<br />
                Edula
              </h2>
              <div class="des white-color mb-40 pr-40 md-pr-0">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt
              </div>
              <a class="readon" href="course.html"
          ...
          <div class="col-lg-7 md-mt-45">
            <div class="row">
              ...
              <div class="col-md-6 mb-30">
                <div class="counter-item d-flex yellow-color">
                  <div class="icon-part">
              ...
              <div class="col-md-6 mb-30">
                <div class="counter-item d-flex ping-color">
                  <div class="icon-part">
              ...
              <div class="col-md-6 mb-30">
                <div class="counter-item d-flex green-color">
                  <div class="icon-part">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 pl-85 md-pl-15">
            <div class="sec-title mb-20">
              ...
              <div class="des mb-40">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore quis nostrud et dolore magna aliqua. Ut enim ad minim veniam.
              </div>
            </div>
            <div class="btn-part wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
              <a class="readon" href="contact.html"
                >Apply Now <i class="flaticon flaticon-right-arrow"></i>
              </a>
            </div>
          </div>
        </div>
    ...
    <!-- Cta Section Start -->
    <div class="sc-cta-section cta-style2 mb-120 md-mb-80">
      <div class="cta-bg-image2 pb-65 pt-70">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-8 col-md-12 md-mb-30 md-text-center">
              <div class="sec-title">
                <div class="sub-title position-relative">
                  About Us <span class="heading-border-line"></span>
                </div>
                <h4 class="title mb-0">25% Offer Running this week</h4>
              </div>
            </div>
            <div class="col-lg-4 text-end col-md-12 md-text-center">
              <div class="btn-part wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                <a class="readon" href="course.html"
                  >Start Course <i class="flaticon flaticon-right-arrow"></i>
                </a>
    ...
    <div
      class="sc-testimonial gray-bg style1 pt-115 pb-120 md-pt-65 md-pb-50 position-relative arrow-animation-1"
    >
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="sec-title pt-25">
              <div class="sub-title primary">
                Client Testimonial1 <span class="heading-border-line"></span>
              </div>
          ...
          <div class="col-lg-8">
            ...
            >
              ...
              <div class="testi-item-inner">
                <div class="testi-item">
                  <div class="desc">
                    Eiusmod consectetur adipiscing elit, sed do tempor incididunt lorem ipsum dolor
                    sit amet.
                  </div>
                  <div class="user-info d-flex align-items-center">
                    <img src="src/assets/images/testimonial/1.png" alt="" />
