                      ...
                      <li class="menu-item-has-children current-menu-item">
                        ...
                        <ul class="sub-menu">
                          <li class="current-menu-item">
                            <a href="course.html">Courses Grid 3</a>
                          </li>
  ...
  <div class="main-content">
    ...
    <div class="sc-breadcrumbs breadcrumbs-overlay">
      ...
      <div class="breadcrumbs-text white-color">
        <h1 class="page-title">Course Column 3</h1>
        <ul>
          <li>
            <a class="active" href="index.html">Home ></a>
          </li>
          <li class="active">Course Column 3</li>
        </ul>
      </div>
    </div>
    <!-- Breadcrumbs End -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse hidecourse">
            <div class="courses-grid">
              <div class="img-part">
                <a href="#"><img src="assets/images/courses/7.jpg" alt="" /></a>
                <div class="course-price">
                  <span class="price">Free</span>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse hidecourse">
            <div class="courses-grid">
              <div class="img-part">
                <a href="#"><img src="assets/images/courses/11.jpg" alt="" /></a>
                <div class="course-price">
                  <span class="price">Free</span>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse hidecourse">
            <div class="courses-grid">
              <div class="img-part">
                <a href="#"><img src="assets/images/courses/12.jpg" alt="" /></a>
                <div class="course-price">
                  <span class="price">$65</span>
                </div>
              </div>
