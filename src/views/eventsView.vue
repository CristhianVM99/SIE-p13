                      ...
                      <li class="menu-item-has-children current-menu-item">
                        ...
                        <ul class="sub-menu">
                          ...
                          <li class="current-menu-item">
                            <a href="#">Events</a>
                            <ul class="sub-menu">
                              <li class="current-menu-item"><a href="events.html">Events 1</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="events-item mb-30 d-flex align-items-center">
              <div class="img-part">
                <a href="course-single.html"><img src="assets/images/events/lg4.jpg" alt="" /></a>
                <div class="event-price">
          ...
          <div class="col-lg-6">
            <div class="events-item mb-30 d-flex align-items-center">
              <div class="img-part">
                <a href="course-single.html"><img src="assets/images/events/lg5.jpg" alt="" /></a>
                <div class="event-price">
                  <span class="price">$45</span>
                </div>
              </div>
          ...
          <div class="col-lg-6">
            <div class="events-item mb-30 d-flex align-items-center">
              <div class="img-part">
                <a href="course-single.html"><img src="assets/images/events/lg6.jpg" alt="" /></a>
                <div class="event-price">
                  <span class="price">$56</span>
                </div>
              </div>
