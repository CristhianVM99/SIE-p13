                        ...
                        <ul class="sub-menu">
                          ...
                          <li class="current-menu-item">
                            ...
                            <ul class="sub-menu">
                              ...
                              <li class="current-menu-item">
                                <a href="gallery2.html">Gallery Filter</a>
                              </li>
  ...
  <div class="main-content">
    ...
    <div class="sc-breadcrumbs breadcrumbs-overlay">
      ...
      <div class="breadcrumbs-text white-color">
        <h1 class="page-title">Gallery Filter</h1>
        <ul>
          <li>
            <a class="active" href="index.html">Home ></a>
          </li>
          <li class="active">Gallery Filter</li>
        </ul>
      </div>
    </div>
    <!-- Breadcrumbs End -->

    <div class="sc-gallery-section pt-120 pb-120 md-pt-80 md-pb-80">
      <div class="container">
        <div class="gridFilter text-center mb-70 md-mb-50">
          <button class="active" data-filter="*">All Gallery</button>
          <button data-filter=".filter1">Students</button>
          <button data-filter=".filter2">Campus</button>
          <button data-filter=".filter3">Photos</button>
        </div>
        <div class="row grid">
          <div class="col-lg-4 col-md-6 grid-item filter1 mb-30">
          ...
          <div class="col-lg-4 col-md-6 grid-item filter4 mb-30">
            <div class="gallery-item">
          ...
          <div class="col-lg-4 col-md-6 grid-item filter2 filter3 mb-30">
            <div class="gallery-item">
          ...
          <div class="col-lg-4 col-md-6 grid-item filter1 filter3 mb-30">
            <div class="gallery-item">
          ...
          <div class="col-lg-4 col-md-6 grid-item filter2 filter1 mb-30">
            <div class="gallery-item">
