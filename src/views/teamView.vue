        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-30">
            <div class="team-wrap">
              ...
              <div class="team-item-text">
                <div class="team-details">
                  <h3 class="team-name"><a href="team-single.html">Borna Khan</a></h3>
                  <span class="team-title">Math Teacher</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-30">
            <div class="team-wrap">
              ...
              <div class="team-item-text">
                <div class="team-details">
                  <h3 class="team-name"><a href="team-single.html">Joshim Khan</a></h3>
                  <span class="team-title">English Teacher</span>
                </div>
              </div>
            </div>
          </div>
