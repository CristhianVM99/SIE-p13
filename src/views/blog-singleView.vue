          ...
          <div class="col-lg-8">
            <div class="blog-deatails">
              ...
              <div class="blog-full">
                ...
                <div class="blog-desc">
                  <h4>Branch of engineering that integrates</h4>
                  <p>
                    Cultivate optimal dolor sit amet, consectetur adipiscing elit, sed do eiusmod
              ...
              <div class="comment-full">
                ...
                >
                  <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 mb-20">
                      <div class="form-group">
                        <input placeholder="Your E-mail" type="email" class="form-control" />
                      </div>
                    </div>
