<template>
                  ...
                  <nav class="sc-menu">
                    <ul class="nav-menu">
                      <li class="menu-item-has-children current-menu-item">
                        ...
                        <ul class="sub-menu">
                          <li class="current-menu-item"><router-link :to="{ name: 'index' }"> Home One</router-link></li>
  ...
  <div class="main-content">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 hidden-md">
            <div
              class="banner-img animation-shape hidden-sm wow fadeInRight"
              data-wow-delay="300ms"
              data-wow-duration="2000ms"
            >
              <img src="src/assets/images/banner/banner-image.png" alt="Banner Image" />
            </div>
            <div
    ...
    <div
      id="sc-about"
      class="sc-about gray-bg pt-90 pb-170 md-pt-50 md-pb-70 position-relative arrow-animation-1"
    >
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5">
            <div class="img-part about-big-image position-relative">
              <img class="" src="src/assets/images/about/about1.png" alt="About Image" />
    ...
    <div
      ...
      class="sc-popular-courses main-home pt-115 pb-90 md-pt-70 md-pb-50"
    >
      <div class="container">
        <div class="row align-items-center mb-30 md-mb-10">
          ...
          <div class="col-md-4 sm-mt-30">
            <div
              class="btn-part sm-text-left text-end wow fadeInRight"
              data-wow-delay="300ms"
              data-wow-duration="2000ms"
            >
        ...
        >
            ...
            <div class="courses-grid">
              <div class="img-part">
                <a href="course-single.html"
                  ><img src="src/assets/images/courses/1.jpg" alt=""
                /></a>
          ...
          <div class="courses-item">
            <div class="courses-grid">
              <div class="img-part">
                <a href="course-single.html"
                  ><img src="src/assets/images/courses/2.jpg" alt=""
                /></a>
                <div class="course-price">
          ...
          <div class="courses-item">
            <div class="courses-grid">
              <div class="img-part">
                <a href="course-single.html"
                  ><img src="src/assets/images/courses/3.jpg" alt=""
                /></a>
                <div class="course-price">
                  <span class="price">Free</span>
                </div>
          ...
          <div class="courses-item">
            <div class="courses-grid">
              <div class="img-part">
                <a href="course-single.html"
                  ><img src="src/assets/images/courses/4.jpg" alt=""
                /></a>
                <div class="course-price">
      ...
      <div class="container">
        ...
        >
          <div class="team-inner-item">
            <div class="team-wrap">
              <div class="team-img">
                <img src="src/assets/images/team/1.jpg" alt="" />
          ...
          <div class="team-inner-item">
            <div class="team-wrap">
              <div class="team-img">
                <img src="src/assets/images/team/2.jpg" alt="" />
                <ul class="team-social">
                  <li>
                    <a href="team-single.html" class="social-icon"
                      ><i class="fa fa-facebook"></i
          ...
          <div class="team-inner-item">
            <div class="team-wrap">
              <div class="team-img">
                <img src="src/assets/images/team/3.jpg" alt="" />
                <ul class="team-social">
                  <li>
                    <a href="team-single.html" class="social-icon"
                      ><i class="fa fa-facebook"></i
          ...
          <div class="team-inner-item">
            <div class="team-wrap">
              <div class="team-img">
                <img src="src/assets/images/team/4.jpg" alt="" />
                <ul class="team-social">
                  <li>
                    <a href="team-single.html" class="social-icon"
                      ><i class="fa fa-facebook"></i
    ...
    <div class="sc-cta-section cta-bg-image md-pt-75 md-pb-80 position-relative arrow-animation-1">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 hidden-md">
            <div class="img-part">
              <img src="src/assets/images/cta/men-women.png" alt="Image" />
            </div>
          </div>
        </div>
      </div>
