<template>
              ...
              <div class="col-lg-7 md-mt-50 pl-45 md-pl-15">
                <div class="sec-title mb-35">
                  ...
                  <div class="des mb-20">
                    ...
                    nostru dexercitation ullamco laboris nisi ut aliquip ex ea commodo consequat
                  </div>
              ...
              <div class="col-lg-4 col-md-6 grid-item filter1">
                <div class="courses-grid image-radius mb-30">
                  ...
                  <div class="content-part">
                    <h3 class="title">
                      <a href="course-single.html">Web Development Course...</a>
                    </h3>
                    <div class="des">
              ...
              <div class="col-lg-4 col-md-6 grid-item filter3 filter2 filter3">
                <div class="courses-grid image-radius mb-30">
                  ...
                  <div class="content-part">
                    ...
                    <ul class="meta-part">
                      <li class="user">
                        <img src="src/ssets/images/courses/user/3.jpg" alt="" />
                        Torio Jokar
                      </li>
                      <li class="user">
                        <i class="flaticon flaticon-play"></i>
              ...
              <div class="col-lg-6 md-mb-50 pr-105 md-pr-15">
                <div class="sec-title mb-35">
                  ...
                  <h2 class="title mb-20">
                    Distinguish your classroom <br />What makes us special?
                  </h2>
      ...
      <footer
        id="sc-footer"
        class="sc-footer footer-style2 footer-bg-image arrow-animation-1 mt-20"
      >
        <div class="container">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-6 text-right md-text-center">
                <form class="newsletter-form">
                  ...
                  <button type="submit">
                    Subscribe <i class="flaticon flaticon-right-arrow"></i>
                  </button>
                </form>
              </div>
            </div>
