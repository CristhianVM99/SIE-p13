      ...
      <div class="container">
        <div class="row clearfix">
          ...
          <div class="image-column col-lg-5 md-mb-50">
            <div class="inner-column">
              ...
              <div class="team-content text-center">
                <h3>Sophia Ava</h3>
                <div class="text">Teacher Fashion</div>
              </div>
          ...
          <div class="content-column col-lg-7 pl-60 pt-50 md-pl-15 md-pt-0">
            <div class="inner-column">
              <h2>Sophia Ava</h2>
              <h4>A certified instructor from edula</h4>

              <ul class="personal-info">
                <li class="email">
                  <span><i class="flaticon flaticon-mail"> </i> </span>
                  <a href="mailto:info@yourwebsite.com">infosimple@gmail.com</a>
                </li>
                <li class="phone">
                  <span><i class="flaticon flaticon-call"></i></span>
                  <a href="tel:+088-589-8745"> +(111)256 352</a>
                </li>
              </ul>
              <!-- Student List -->
              <ul class="student-list">
                <li>87,950 Total Students</li>
                <li>
                  <span class="theme_color">4.5</span> <span class="fa fa-star"></span
                  ><span class="fa fa-star"></span><span class="fa fa-star"></span
                  ><span class="fa fa-star"></span><span class="fa fa-star"></span> (8657 Rating)
                </li>
                <li>256 Reviews</li>
              </ul>
              <h5>About Me</h5>
              <p>
                ...
                exerci doming id quod mazim placerat tation ullamcorper suscipit lobortis nisl ut
