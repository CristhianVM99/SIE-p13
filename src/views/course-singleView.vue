          ...
          <div class="col-lg-8 md-mb-50">
            ...
            <div class="intro-info-tabs">
              ...
              <div class="tab-content tabs-content" id="myTabContent">
                  ...
                  <div class="content white-bg pt-30">
                    ...
                    <div class="course-overview">
                      <div class="inner-box mb-30">
                        <h3>Topic Is Computer Science</h3>
                        <p>
                          Malesuada tempor sit amet, consectetur adipiscing elit, sed do eiusmod
                          tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
                          veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                          commodo consequat fugiat nulla pariatur.
                        </p>
                        <ul class="review-list">
                          <li>Academy of Art University Library</li>
                          <li>Confident using Any software</li>
                          <li>Our Quality Teachers</li>
                          <li>Become an instructortoday</li>
                        </ul>
                      </div>
                      <a class="readon" href="#"
                        ...
                        >
                          <div class="card-body acc-content current">
                            <div class="content">
                              <div class="clearfix">
                                <div class="pull-left">
                                  <a class="popup-videos play-icon" href="#"
                                    ><i class="fa fa-play"></i> <span>Lecture: 01</span> Course
                                    Introduction</a
                                  >
                                </div>
                            ...
                            <div class="content">
                              <div class="clearfix">
                                <div class="pull-left">
                                  <a class="popup-videos play-icon" href="#"
                                    ><i class="fa fa-play"></i> <span>Lecture: 02</span> Big Picture
                            ...
                            <div class="content">
                              <div class="clearfix">
                                <div class="pull-left">
                                  <a class="popup-videos play-icon" href="#"
                                    ><i class="fa fa-play"></i> <span>Lecture: 03</span> HTML
                      ...
                      <div class="card accordion block">
                        <div class="card-header" id="headingThree">
                          <h5 class="mb-0">
                            ...
                            >
                              Part 03: Adding Media to a Web Page
                            </button>
                          </h5>
                        </div>
                        <div
                ...
                <div
                  class="tab-pane fade sc-team team-style-style-1"
                  id="prod-instructor"
                  role="tabpanel"
                ...
                >
                  <div class="content pt-30">
                    <div class="cource-review-box mb-30">
                      <h4>Alart Deen</h4>
                      <div class="rating">
                        <span class="total-rating">4.5</span> <span class="fa fa-star"></span
                        ><span class="fa fa-star"></span><span class="fa fa-star"></span
                        ><span class="fa fa-star"></span><span class="fa fa-star"></span>&ensp; 473
                        Reviews
                      </div>
                      <div class="text">
                        Venenatis sit amet ornare non, suscipit nec risus. suscipit enim magna,
                        varius et commodo ut, ultricies vitae velit. Ut nulla tellus, eleifend
          ...
          <div class="course-sidebar-area col-lg-4">
            <div class="inner-column">
              <div class="course-features-info">
                ...
                <a class="readon mt-20" href="#"
                  >Enroll Now <i class="flaticon flaticon-right-arrow"></i>
                </a>
              </div>
              <div class="course-features-info">
                ...
                <ul>
                  <li class="lectures-feature">
                    <a href="#"><span class="label">General Education</span></a>
                    <span class="value">(02)</span>
                  </li>

                  <li class="duration-feature">
                    <a href="#"><span class="label">Computer Science</span></a>
                    <span class="value">(10)</span>
                  </li>

                  <li class="quizzes-feature">
                    <a href="#"><span class="label">Civil Engineering</span></a>
                    <span class="value">(03)</span>
                  </li>

                  <li class="students-feature">
                    <a href="#"><span class="label">Artificial Intelligence</span></a>
                    <span class="value">(21)</span>
                  </li>

                  <li class="assessments-feature">
                    <a href="#"><span class="label">Business Studies</span></a>
                    <span class="value">(06)</span>
                  </li>

                  <li class="assessments-feature">
                    <a href="#"><span class="label">Computer Engineering</span></a>
                    <span class="value">(07)</span>
                  </li>

                  <li class="assessments-feature">
                    <a href="#"><span class="label">Web Development</span></a>
