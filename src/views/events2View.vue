                        ...
                        <ul class="sub-menu">
                          ...
                          <li class="current-menu-item">
                            ...
                            <ul class="sub-menu">
                              ...
                              <li class="current-menu-item"><a href="events2.html">Events 2</a></li>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/1.jpg" alt="" /></a>
              ...
              <div class="content-part">
                ...
                <ul class="meta-part">
                  ...
                  <li class="event-date"><i class="fa fa-calendar-check-o"></i>July 24, 2020</li>
                </ul>
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/2.jpg" alt="" /></a>
                <div class="event-price">
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/3.jpg" alt="" /></a>
                <div class="event-price">
                  <span class="price">$70</span>
                </div>
              </div>
              <div class="content-part">
                <h3 class="title"><a href="course-single.html">University Ranking</a></h3>
                <div class="des">
                  Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
                </div>
                <ul class="meta-part">
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/4.jpg" alt="" /></a>
                <div class="event-price">
                  <span class="price">$36</span>
                </div>
              </div>
              <div class="content-part">
                <h3 class="title"><a href="course-single.html">Spark Of Genius</a></h3>
                <div class="des">
                  Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
                </div>
                <ul class="meta-part">
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/5.jpg" alt="" /></a>
                <div class="event-price">
                  <span class="price">Free</span>
                </div>
              </div>
              <div class="content-part">
                <h3 class="title"><a href="course-single.html">Work Life Balance</a></h3>
                <div class="des">
                  Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
                </div>
                <ul class="meta-part">
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/6.jpg" alt="" /></a>
                <div class="event-price">
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse hidecourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/7.jpg" alt="" /></a>
                <div class="event-price">
                  <span class="price">Free</span>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse hidecourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/8.jpg" alt="" /></a>
                <div class="event-price">
                  <span class="price">$85</span>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse hidecourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/9.jpg" alt="" /></a>
                <div class="event-price">
                  <span class="price">$70</span>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse hidecourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/10.jpg" alt="" /></a>
                <div class="event-price">
                  <span class="price">$36</span>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse hidecourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/11.jpg" alt="" /></a>
                <div class="event-price">
                  <span class="price">Free</span>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-30 loadcourse addcourse hidecourse">
            <div class="events-item">
              <div class="img-part">
                <a href="#"><img src="assets/images/events/12.jpg" alt="" /></a>
                <div class="event-price">
                  <span class="price">$65</span>
                </div>
              </div>
