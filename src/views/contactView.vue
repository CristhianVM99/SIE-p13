            ...
            <div class="col-md-7">
              <ul class="topbar-contact">
                ...
                <li>
                  ...
                  <a href="mailto:support@softcoders.net">support@softcoders.net</a>
                </li>
              </ul>
            </div>
            ...
            <div class="contact-info contact-address">
              ...
              <div class="content-part">
                ...
                <ul class="contact-list">
                  <li><span>Phone: </span><a href="tel:+(111)256352">+(111) 256 352</a></li>
                  <li><span>Tell: </span><a href="tel:+(111)256352">002 256 352 356</a></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="contact-info contact-mail">
              ...
              <div class="content-part">
                ...
                <ul class="contact-list">
                  ...
                  <li>
                    <span>Office: </span><a href="mailto:learning@gmail.com">learning@gmail.com</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="col-lg-4 lg-pr-0">
            <div class="contact-info contact-phone">
              ...
              <div class="content-part">
                ...
                <div class="address-des">202 Raffles Ave, Carlisle CA2 7EF, United Kingdon</div>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-5 md-mb-30">
            <div class="contact-map">
              <iframe
                src="https://maps.google.com/maps?q=mirpur%20stadium&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed"
              ></iframe>
            </div>
          </div>
