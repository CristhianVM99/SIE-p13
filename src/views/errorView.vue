                    ...
                    <ul class="nav-menu">
                      ...
                      <li class="menu-item-has-children current-menu-item">
                        ...
                        <ul class="sub-menu">
                          ...
                          <li class="current-menu-item"><a href="error.html">404 Page</a></li>
                        </ul>
                      </li>
                      <li class="menu-item-has-children">
                        <a href="#">Blog</a>
  ...
  <div class="main-content">
    ...
    <div id="sc-page-error" class="sc-page-error">
      <div class="error-text">
        ...
        <a class="readon" href="index.html" title="Home"
          >Back to Homepage <i class="flaticon flaticon-right-arrow"></i
        ></a>
      </div>
    </div>
