  ...
  <div class="main-content">
    ...
    <div class="sc-breadcrumbs breadcrumbs-overlay">
      ...
      <div class="breadcrumbs-text white-color">
        <h1 class="page-title">Blog 2</h1>
        <ul>
          <li>
            <a class="active" href="index.html">Home ></a>
          </li>
          <li class="active">Blog 2</li>
        </ul>
      </div>
    </div>
    <!-- Breadcrumbs End -->
    ...
    <!-- Blog Section Start -->
    <div id="sc-blog" class="sc-blog blog-list pb-110 pt-120 md-pb-70 md-pt-80">
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            <div class="blog-item mb-30 loadgallery addcourse">
              ...
              <div class="blog-content">
                <ul class="blog-meta">
                  ...
                  <li><i class="fa fa-calendar"></i>December 02, 2021</li>
                </ul>
            ...
            <div class="blog-item mb-30 loadgallery addcourse hidecourse">
              <div class="image-part">
                <img src="assets/images/blog/b1.jpg" alt="" />
              </div>
              <div class="blog-content">
            ...
            <div id="loadmore" class="mt-30 md-mt-10">
              <a class="readon" href="#"
                >Learn More <i class="flaticon flaticon-right-arrow"></i>
              </a>
            </div>
          </div>
          <div class="col-lg-4 col-md-12 md-mt-60 sc-blog-single">
            <div class="widget-area">
              ...
              <div class="recent-posts-widget mb-50">
                ...
                <div class="show-featured">
                  ...
                  <div class="post-desc">
                    <a href="#">Branch of engineering that integrates</a>
                    <span class="date">
                ...
                <div class="show-featured">
                  ...
                  <div class="post-desc">
                    <a href="#">Refers to the simulation of human intelligence </a>
                    <span class="date">
                      <i class="fa fa-calendar"></i>
                      April 5, 2021
                    </span>
                ...
                <div class="show-featured">
                  ...
                  <div class="post-desc">
                    <a href="#">Civil Engineering the simulation intelligence</a>
                    <span class="date">
                      <i class="fa fa-calendar"></i>
                      April 6, 2021
                    </span>
